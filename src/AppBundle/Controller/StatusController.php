...
class StatusController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('statusIndex', array('id' => $status->getId()));
        }
    ...
    public function editAction(Request $request, Status $status)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('statusEdit', array('id' => $status->getId()));
        }
    ...
    public function deleteAction(Request $request, Status $status)
    {
        ...
        return $this->redirectToRoute('statusIndex');
    }
